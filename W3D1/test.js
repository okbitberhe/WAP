...
describe("deposit to balance", function() {
...
describe("withdraw from balance", function() {
...
describe("getInterest for saving", function() {
    it("returns the interest of a saving account", function() {
        let sa = new SavingsAccount(1);
        sa.setInterest(10);
...
describe("addInterest", function() {
    it("returns the interest of a saving account", function() {
        let sa = new SavingsAccount(1, 10);
        sa.deposit(100);
        sa.addInterest();
...
describe("withdraw money from checking account", function() {
    it("withdraw money from a checking account", function() {
        let ca = new CheckingAccount(1, 100);
        ca.deposit(100);
        ca.withdraw(50);
...
describe("withdraw money from balance", function() {
