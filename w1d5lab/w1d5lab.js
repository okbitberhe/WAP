...
myFunctionTest(5, findLongestWord(["Hello", "World", "Goodbye"]), "Expected output of findLongestWord(['Hello','World', 'Godbye']) is ");

myFunctionTest(["three", "Eritrea"], filterLongWords(["one", "three", "Eritrea"], 3), "Expected output of filterLongWords(['one','three', 'Eritrea'],3) is ");